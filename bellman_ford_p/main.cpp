...
public:
  ...
  void bellman_ford(T sorgente, int n_archi, int n_nodi, int max_iterations) {
...
int main() {
  ...
  for (int i = 0; i < TASK; i++) {
    input >> nodi >> archi >> type >> max_iterations;
    ...
    grafo.bellman_ford(sorgente, archi, nodi, max_iterations);
